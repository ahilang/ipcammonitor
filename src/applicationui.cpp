...
void ApplicationUI::clearsnapshot()
{
    remove("/accounts/1000/appdata/com.example.ipcammonitor.testDev_pcammonitord0182b63/tmp/snapshot.jpeg");
}
...
void ApplicationUI::onSystemLanguageChanged()
{
    ...
    QString file_name = QString("ipcammonitor_%1").arg(locale_string);
